    ...
    <section class="attractionSection">
        <div class="container">
            ...
            <form class="form" action="{{route('attractions.destroy', $attraction)}}" method="POST">
                ...
                <div class="form-group">
                    <label for="categorie_id">Id van de categorie</label>
                    <input disabled id="categorie_id" name="categorie_id" class="form-control" type="number" value="{{ $attraction->categorie_id }}" />
                </div>
                <div class="form-group">
                    <label for="facilitie_id">Id van de faciliteit</label>
                    <input disabled id="facilitie_id" name="facilitie_id" class="form-control" type="number" value="{{ $attraction->facilitie_id }}" />
                </div>
